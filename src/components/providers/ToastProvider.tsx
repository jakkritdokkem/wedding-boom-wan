        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto flex items-center justify-between p-4 rounded-xl shadow-xl backdrop-blur-md bg-stone-900/90 border border-[#D4AF37]/40 text-stone-100"
            >
              ...
              <button
                ...
                className="p-1 hover:bg-stone-800 rounded-lg text-stone-400 hover:text-white transition"
              >
                <X className="w-4 h-4" />
              </button>
            </motion.div>
